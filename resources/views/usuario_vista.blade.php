                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <form action="administracion_vista" method="post">
                                    {!! csrf_field(); !!}
                                    <button  type="submit" name="btnadmin"  class="nav-link btn bg-dark">Administración<span class="sr-only">(current)</span></button>
                                </form>
                            </li>
                        </ul>
                    <?php } else {
