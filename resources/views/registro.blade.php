                    ...
                    <div class="col-12">
                        <div class="row mt-2">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="row justify-content-center">
                                    <input class="col-xl-4 col-lg-4 col-md-8 col-sm-10 col-10 mb-3 form-control text-center" type="text" id="user" name="user" placeholder="nombre de usuario" required>
                                    <div class="col-xl-1 col-lg-1 col-md-0 col-sm-0 col-0"></div>
                                    <input class="col-xl-4 col-lg-4 col-md-8 col-sm-10 col-10 mb-3 form-control text-center" type="password" id="pass" name="pass" placeholder="contraseña" required>
                                </div>
                                <div class="row justify-content-center">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <input type="submit" id="registrar" class="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-8 btn btn-dark text-white" value="Aceptar">
                                    <div class="col-xl-4 col-lg-4 col-md-3 col-sm-2 col-2"></div>
                                </div>
                            </div>
                        </div>
